...
public final class TransitionEvent extends AbstractWorkflowEvent {
    public TransitionEvent(@NotNull Object source, @NotNull Marking marking, Transition transition, WorkflowInterface workflow) {
