...
public final class EnteredEvent extends AbstractWorkflowEvent {
    public EnteredEvent(@NotNull Object source, @NotNull Marking marking, Transition transition, WorkflowInterface workflow) {
