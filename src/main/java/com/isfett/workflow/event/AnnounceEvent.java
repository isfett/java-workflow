...
public final class AnnounceEvent extends AbstractWorkflowEvent {
    public AnnounceEvent(@NotNull Object source, @NotNull Marking marking, Transition transition, WorkflowInterface workflow) {
